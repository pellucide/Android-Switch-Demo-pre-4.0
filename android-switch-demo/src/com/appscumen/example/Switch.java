...
import com.velis.library.R;
import com.velis.library.log;
...
public class Switch extends CompoundButton
{
  ...
  public Switch(Context context, AttributeSet attrs, int defStyle)
  {
    ...
    mTextPaint.setShadowLayer(0.5f, 1.0f, 1.0f, res.getColor(R.color.textNormal));
    mTextPaint.setTextSize(16 * density);
    mTextPaint.setColor(res.getColor(R.color.textInvertedNormal));
    ...
    if (mTrackDrawable == null)
    {
      ...
      trk.setColor(res.getColor(R.color.colorAccent));
